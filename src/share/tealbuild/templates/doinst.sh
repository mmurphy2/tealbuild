# doinst.sh for {{ name }}
#
# IMPORTANT: This is a comprehensive template (from SlackBuilds.org). Remove
# anything your package isn't using before renaming to doinst.sh! (Or delete
# entirely if doinst.sh is not needed.)
config() {
  NEW="$1"
